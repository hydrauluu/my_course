...
**1.** Напишите цикл который выводит все числа от 1 до 100 кроме кратных 3.

**2.** Ввести три числа через запятую и вывести True или False в зависимости от того, могут ли эти числа быть сторонами треугольника (проверять строгое неравенство).  

**3.** Объясните код ниже.
